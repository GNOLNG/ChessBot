...
- With the assistance of a trusted friend: open the "ChessBot" > locate and click the login button on left buttom of the front page > login your chess.com account
<img width="649" alt="image" src="https://github.com/GNOLNG/chess.com-bot-for-visually-impaired/assets/92449126/38b80310-dc7d-423b-9cf6-fb9a3d8136dc">


## How to use
**Only two key to remember**
  - **1. press Control + O, the bot will tell options that you can made on that state. So, press Control + O when you get lost.**
...
**Make a move**
  ...
  There are two command supported to make a move : command mode and arrow mode
...
| e7e8q | move piece on e7 (pawn) to e8 and promote to queen |
  ...
  - **3. After input a move, a confirm dialog shown up. Press enter or space bar to confirm. Or press delete to cancel.** 

- **For arrow mode: Control + J to enter arrow mode**
  - **Use arrow key to travel the chess board**
  - **Meanwhile, the bot will tell you the piece on that square.**
  - **press space bar to select the target piece, travel to the square you wanted to place, and press space bar again**


**Opponent Move**
  - **1.after your opponent make their move, the bot will speak out their move**
  - For example, white pawn move to h8 and promote to queen and check

**Query information**
  - **1. Type the word "time" to check the remaining time of current game**
  - **2. Type the word "where" followed by piece type to check the location of that piece, e.g. where knight / where k**
  - **3. Type the word "what" followed by square name to check the piece type on that square, e.g. what a2**
...
**Game end**
  ...
  - **You must resign from current game before start another game**
